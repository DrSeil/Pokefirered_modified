...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_OLD_MAN_BARB / 2]                = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MON), // OBJ_EVENT_GFX_BILL_MARIO
    [OBJ_EVENT_GFX_OAK_FANCY / 2]                = COLORS(NPC_TEXT_COLOR_MALE, NPC_TEXT_COLOR_MALE), // OBJ_EVENT_GFX_OAK_SWIM
    [OBJ_EVENT_GFX_MOM_FANCY / 2]                = COLORS(NPC_TEXT_COLOR_FEMALE, NPC_TEXT_COLOR_FEMALE), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO1 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO3 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO5 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO7 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO9 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO11 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO13 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO15 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO17 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO19 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO21 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO23 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO25 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO28 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO30 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_MAUSO32 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_BLOOD1 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_BLOOD22 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_BLOOD31 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_BLOOD33 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
    [OBJ_EVENT_GFX_BLOOD42 / 2]                = COLORS(NPC_TEXT_COLOR_NEUTRAL, NPC_TEXT_COLOR_NEUTRAL), // OBJ_EVENT_GFX_MOM_SWIM
};
