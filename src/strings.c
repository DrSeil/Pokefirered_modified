...
const u8 gText_BillSPc[] = _("CHRIS'S PC");
...
const u8 gText_ReleaseThisPokemon[] = _("Kill this POKéMON?");
...
const u8 gPCText_Release[] = _("KILL");
...
const u8 gText_Release1[] = _("{DYNAMIC 0x00} was {PAUSE 0x3C}"); 
const u8 gText_Release2[] = _("euthanized.{PAUSE 0x3C}"); 
const u8 gText_Release3[] = _(""); 
const u8 gText_Release4[] = _("{DYNAMIC 0x00} was ended {PAUSE 0x3C}"); 
const u8 gText_Release5[] = _("before its time.{PAUSE 0x3C}"); 
const u8 gText_Release6[] = _(""); 
const u8 gText_Release7[] = _("{DYNAMIC 0x00} was taken out {PAUSE 0x3C}"); 
const u8 gText_Release8[] = _("back and bludgeoned to {PAUSE 0x3C}"); 
const u8 gText_Release9[] = _("death.{PAUSE 0x3C}"); 
const u8 gText_Release10[] = _("{DYNAMIC 0x00} was your 'mon.{PAUSE 0x3C}"); 
const u8 gText_Release11[] = _(" You shot it.{PAUSE 0x3C}"); 
const u8 gText_Release12[] = _(""); 
const u8 gText_Release13[] = _("{DYNAMIC 0x00} will never {PAUSE 0x3C}"); 
const u8 gText_Release14[] = _("love again.{PAUSE 0x3C}"); 
const u8 gText_Release15[] = _(""); 
const u8 gText_Release16[] = _("{DYNAMIC 0x00} has drawn its {PAUSE 0x3C}"); 
const u8 gText_Release17[] = _("last breaths.{PAUSE 0x3C}"); 
const u8 gText_Release18[] = _(""); 
const u8 gText_Release19[] = _("{DYNAMIC 0x00} shuffled off {PAUSE 0x3C}"); 
const u8 gText_Release20[] = _("this mortal coil.{PAUSE 0x3C}"); 
const u8 gText_Release21[] = _(""); 
const u8 gText_Release22[] = _("{DYNAMIC 0x00} came to a {PAUSE 0x3C}"); 
const u8 gText_Release23[] = _("sticky end.{PAUSE 0x3C}"); 
const u8 gText_Release24[] = _(""); 
const u8 gText_Release25[] = _("{DYNAMIC 0x00} crossed the {PAUSE 0x3C}"); 
const u8 gText_Release26[] = _("Jordan.{PAUSE 0x3C}"); 
const u8 gText_Release27[] = _(""); 
const u8 gText_Release28[] = _("{DYNAMIC 0x00} is worm food.{PAUSE 0x3C}"); 
const u8 gText_Release29[] = _(""); 
const u8 gText_Release30[] = _(""); 
const u8 gText_Release31[] = _("{DYNAMIC 0x00} moved to a {PAUSE 0x3C}"); 
const u8 gText_Release32[] = _("big farm upstate.{PAUSE 0x3C}"); 
const u8 gText_Release33[] = _(""); 
const u8 gText_Release34[] = _("{DYNAMIC 0x00} got hit by a {PAUSE 0x3C}"); 
const u8 gText_Release35[] = _("bus.{PAUSE 0x3C}"); 
const u8 gText_Release36[] = _(""); 
const u8 gText_Release37[] = _("{DYNAMIC 0x00} made the {PAUSE 0x3C}"); 
const u8 gText_Release38[] = _("ultimate sacrifice… to {PAUSE 0x3C}"); 
const u8 gText_Release39[] = _("make room in our bag.{PAUSE 0x3C}"); 
const u8 gText_Release40[] = _("{DYNAMIC 0x00} is no longer {PAUSE 0x3C}"); 
const u8 gText_Release41[] = _("with us.{PAUSE 0x3C}"); 
const u8 gText_Release42[] = _(""); 
const u8 gText_Release43[] = _("{DYNAMIC 0x00} kicked the {PAUSE 0x3C}"); 
const u8 gText_Release44[] = _("bucket.{PAUSE 0x3C}"); 
const u8 gText_Release45[] = _(""); 
const u8 gText_Release46[] = _("{DYNAMIC 0x00} passed {PAUSE 0x3C}"); 
const u8 gText_Release47[] = _("peacefully in its sleep.{PAUSE 0x3C}"); 
const u8 gText_Release48[] = _(""); 
const u8 gText_Release49[] = _("{DYNAMIC 0x00} joined the {PAUSE 0x3C}"); 
const u8 gText_Release50[] = _("great majority.{PAUSE 0x3C}"); 
const u8 gText_Release51[] = _(""); 
const u8 gText_Release52[] = _("{DYNAMIC 0x00} lost their {PAUSE 0x3C}"); 
const u8 gText_Release53[] = _("life.{PAUSE 0x3C}"); 
const u8 gText_Release54[] = _(""); 
const u8 gText_Release55[] = _("{DYNAMIC 0x00} has met their {PAUSE 0x3C}"); 
const u8 gText_Release56[] = _("maker.{PAUSE 0x3C}"); 
const u8 gText_Release57[] = _(""); 
const u8 gText_Release58[] = _("{DYNAMIC 0x00} was removed {PAUSE 0x3C}"); 
const u8 gText_Release59[] = _("from life support.{PAUSE 0x3C}"); 
const u8 gText_Release60[] = _(""); 
const u8 gText_Release61[] = _("{DYNAMIC 0x00} crossed the {PAUSE 0x3C}"); 
const u8 gText_Release62[] = _("rainbow bridge to {PAUSE 0x3C}"); 
const u8 gText_Release63[] = _("Valhalla.{PAUSE 0x3C}"); 
const u8 gText_Release64[] = _("{DYNAMIC 0x00} was {PAUSE 0x3C}"); 
const u8 gText_Release65[] = _("terminated.{PAUSE 0x3C}"); 
const u8 gText_Release66[] = _(""); 
const u8 gText_Release67[] = _("{DYNAMIC 0x00} was erased. {PAUSE 0x3C}"); 
const u8 gText_Release68[] = _("Erased… from existence.{PAUSE 0x3C}"); 
const u8 gText_Release69[] = _(""); 
const u8 gText_Release70[] = _("{DYNAMIC 0x00} was wasted.{PAUSE 0x3C}"); 
const u8 gText_Release71[] = _(""); 
const u8 gText_Release72[] = _(""); 
const u8 gText_Release73[] = _("{DYNAMIC 0x00} was wiped out.{PAUSE 0x3C}"); 
const u8 gText_Release74[] = _(""); 
const u8 gText_Release75[] = _(""); 
const u8 gText_Release76[] = _("{DYNAMIC 0x00} was destroyed.{PAUSE 0x3C}"); 
const u8 gText_Release77[] = _(""); 
const u8 gText_Release78[] = _(""); 
const u8 gText_Release79[] = _("{DYNAMIC 0x00} was pumped {PAUSE 0x3C}"); 
const u8 gText_Release80[] = _("full of lead.{PAUSE 0x3C}"); 
const u8 gText_Release81[] = _(""); 
const u8 gText_Release82[] = _("{DYNAMIC 0x00} is history.{PAUSE 0x3C}"); 
const u8 gText_Release83[] = _(""); 
const u8 gText_Release84[] = _(""); 
const u8 gText_Release85[] = _("{DYNAMIC 0x00} died of a {PAUSE 0x3C}"); 
const u8 gText_Release86[] = _("broken heart.{PAUSE 0x3C}"); 
const u8 gText_Release87[] = _(""); 
const u8 gText_Release88[] = _("{DYNAMIC 0x00} went on to a {PAUSE 0x3C}"); 
const u8 gText_Release89[] = _("better place.{PAUSE 0x3C}"); 
const u8 gText_Release90[] = _(""); 
const u8 gText_Release91[] = _("{DYNAMIC 0x00} went to the {PAUSE 0x3C}"); 
const u8 gText_Release92[] = _("glue factory.{PAUSE 0x3C}"); 
const u8 gText_Release93[] = _(""); 
const u8 gText_Release94[] = _("{DYNAMIC 0x00} is now {PAUSE 0x3C}"); 
const u8 gText_Release95[] = _("extinct.{PAUSE 0x3C}"); 
const u8 gText_Release96[] = _(""); 
const u8 gText_Release97[] = _("{DYNAMIC 0x00} fell off the {PAUSE 0x3C}"); 
const u8 gText_Release98[] = _("toilet.{PAUSE 0x3C}"); 
const u8 gText_Release99[] = _(""); 
const u8 gText_Release100[] = _("{DYNAMIC 0x00} was {PAUSE 0x3C}"); 
const u8 gText_Release101[] = _("exterminated.{PAUSE 0x3C}"); 
const u8 gText_Release102[] = _(""); 
const u8 gText_Release103[] = _("{DYNAMIC 0x00} was abandoned {PAUSE 0x3C}"); 
const u8 gText_Release104[] = _("in a roadside ditch.{PAUSE 0x3C}"); 
const u8 gText_Release105[] = _(""); 
const u8 gText_Release106[] = _("{DYNAMIC 0x00} was left in a {PAUSE 0x3C}"); 
const u8 gText_Release107[] = _("shallow grave.{PAUSE 0x3C}"); 
const u8 gText_Release108[] = _(""); 
const u8 gText_Release109[] = _("{DYNAMIC 0x00} bought the {PAUSE 0x3C}"); 
const u8 gText_Release110[] = _("farm.{PAUSE 0x3C}"); 
const u8 gText_Release111[] = _(""); 
const u8 gText_Release112[] = _("{DYNAMIC 0x00} bit the dust.{PAUSE 0x3C}"); 
const u8 gText_Release113[] = _(""); 
const u8 gText_Release114[] = _(""); 
const u8 gText_Release115[] = _("{DYNAMIC 0x00} went beyond {PAUSE 0x3C}"); 
const u8 gText_Release116[] = _("the veil.{PAUSE 0x3C}"); 
const u8 gText_Release117[] = _(""); 
const u8 gText_Release118[] = _("{DYNAMIC 0x00} is now at {PAUSE 0x3C}"); 
const u8 gText_Release119[] = _("peace.{PAUSE 0x3C}"); 
const u8 gText_Release120[] = _(""); 
const u8 gText_Release121[] = _("{DYNAMIC 0x00} has gone away.{PAUSE 0x3C}"); 
const u8 gText_Release122[] = _(" It's so hard to say {PAUSE 0x3C}"); 
const u8 gText_Release123[] = _("goodbye to yesterday.{PAUSE 0x3C}"); 
const u8 gText_Release124[] = _("{DYNAMIC 0x00} went to hell. {PAUSE 0x3C}"); 
const u8 gText_Release125[] = _("It burns forever.{PAUSE 0x3C}"); 
const u8 gText_Release126[] = _(""); 
const u8 gText_Release127[] = _("{DYNAMIC 0x00} took a bat to {PAUSE 0x3C}"); 
const u8 gText_Release128[] = _("the face.{PAUSE 0x3C}"); 
const u8 gText_Release129[] = _(""); 
const u8 gText_Release130[] = _("{DYNAMIC 0x00} can finally {PAUSE 0x3C}"); 
const u8 gText_Release131[] = _("rest.{PAUSE 0x3C}"); 
const u8 gText_Release132[] = _(""); 
const u8 gText_Release133[] = _("{DYNAMIC 0x00} was useless {PAUSE 0x3C}"); 
const u8 gText_Release134[] = _("anyway.{PAUSE 0x3C}"); 
const u8 gText_Release135[] = _(""); 
const u8 gText_Release136[] = _("{DYNAMIC 0x00} has been {PAUSE 0x3C}"); 
const u8 gText_Release137[] = _("replaced.{PAUSE 0x3C}"); 
const u8 gText_Release138[] = _(""); 
const u8 gText_Release139[] = _("{DYNAMIC 0x00} was snuffed {PAUSE 0x3C}"); 
const u8 gText_Release140[] = _("out.{PAUSE 0x3C}"); 
const u8 gText_Release141[] = _(""); 
const u8 gText_Release142[] = _("{DYNAMIC 0x00} cried as it {PAUSE 0x3C}"); 
const u8 gText_Release143[] = _("slowly suffocated under {PAUSE 0x3C}"); 
const u8 gText_Release144[] = _("a pillow.{PAUSE 0x3C}"); 
const u8 gText_Release145[] = _("{DYNAMIC 0x00} doesn't wanna {PAUSE 0x3C}"); 
const u8 gText_Release146[] = _("go, Mr. Stark.{PAUSE 0x3C}"); 
const u8 gText_Release147[] = _(""); 
const u8 gText_Release148[] = _("{DYNAMIC 0x00} closed its {PAUSE 0x3C}"); 
const u8 gText_Release149[] = _("eyes for the last time.{PAUSE 0x3C}"); 
const u8 gText_Release150[] = _(""); 
const u8 gText_Release151[] = _("{DYNAMIC 0x00} turned in for {PAUSE 0x3C}"); 
const u8 gText_Release152[] = _("the big sleep.{PAUSE 0x3C}"); 
const u8 gText_Release153[] = _(""); 
const u8 gText_Release154[] = _("{DYNAMIC 0x00} is done being {PAUSE 0x3C}"); 
const u8 gText_Release155[] = _("alive.{PAUSE 0x3C}"); 
const u8 gText_Release156[] = _(""); 
const u8 gText_Release157[] = _("{DYNAMIC 0x00} is shiny and {PAUSE 0x3C}"); 
const u8 gText_Release158[] = _("chrome. WITNESS THEM!"); 
const u8 gText_Release159[] = _(""); 
const u8 gText_Release160[] = _("{DYNAMIC 0x00} shall become {PAUSE 0x3C}"); 
const u8 gText_Release161[] = _("more powerful than you {PAUSE 0x3C}"); 
const u8 gText_Release162[] = _("can possibly imagine.{PAUSE 0x3C}"); 
const u8 gText_Release163[] = _("{DYNAMIC 0x00} drank from {PAUSE 0x3C}"); 
const u8 gText_Release164[] = _("the wrong chalice.{PAUSE 0x3C}"); 
const u8 gText_Release165[] = _(""); 