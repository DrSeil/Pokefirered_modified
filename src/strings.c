...
const u8 gText_Release1[] = _("{DYNAMIC 0x00} was "); 
const u8 gText_Release2[] = _("euthanized."); 
const u8 gText_Release3[] = _(""); 
const u8 gText_Release4[] = _("{DYNAMIC 0x00} was ended "); 
const u8 gText_Release5[] = _("before its time."); 
const u8 gText_Release6[] = _(""); 
const u8 gText_Release7[] = _("{DYNAMIC 0x00} was taken out "); 
const u8 gText_Release8[] = _("back and bludgeoned to "); 
const u8 gText_Release9[] = _("death."); 
const u8 gText_Release10[] = _("{DYNAMIC 0x00} was your 'mon."); 
const u8 gText_Release11[] = _(" You shot it."); 
const u8 gText_Release12[] = _(""); 
const u8 gText_Release13[] = _("{DYNAMIC 0x00} will never "); 
const u8 gText_Release14[] = _("love again."); 
const u8 gText_Release15[] = _(""); 
const u8 gText_Release16[] = _("{DYNAMIC 0x00} has drawn its "); 
const u8 gText_Release17[] = _("last breaths."); 
const u8 gText_Release18[] = _(""); 
const u8 gText_Release19[] = _("{DYNAMIC 0x00} shuffled off "); 
const u8 gText_Release20[] = _("this mortal coil."); 
const u8 gText_Release21[] = _(""); 
const u8 gText_Release22[] = _("{DYNAMIC 0x00} came to a "); 
const u8 gText_Release23[] = _("sticky end."); 
const u8 gText_Release24[] = _(""); 
const u8 gText_Release25[] = _("{DYNAMIC 0x00} crossed the "); 
const u8 gText_Release26[] = _("Jordan."); 
const u8 gText_Release27[] = _(""); 
const u8 gText_Release28[] = _("{DYNAMIC 0x00} is worm food."); 
const u8 gText_Release29[] = _(""); 
const u8 gText_Release30[] = _(""); 
const u8 gText_Release31[] = _("{DYNAMIC 0x00} moved to a "); 
const u8 gText_Release32[] = _("big farm upstate."); 
const u8 gText_Release33[] = _(""); 
const u8 gText_Release34[] = _("{DYNAMIC 0x00} got hit by a "); 
const u8 gText_Release35[] = _("bus."); 
const u8 gText_Release36[] = _(""); 
const u8 gText_Release37[] = _("{DYNAMIC 0x00} made the "); 
const u8 gText_Release38[] = _("ultimate sacrifice… to "); 
const u8 gText_Release39[] = _("make room in our bag."); 
const u8 gText_Release40[] = _("{DYNAMIC 0x00} is no longer "); 
const u8 gText_Release41[] = _("with us."); 
const u8 gText_Release42[] = _(""); 
const u8 gText_Release43[] = _("{DYNAMIC 0x00} kicked the "); 
const u8 gText_Release44[] = _("bucket."); 
const u8 gText_Release45[] = _(""); 
const u8 gText_Release46[] = _("{DYNAMIC 0x00} passed "); 
const u8 gText_Release47[] = _("peacefully in its sleep."); 
const u8 gText_Release48[] = _(""); 
const u8 gText_Release49[] = _("{DYNAMIC 0x00} joined the "); 
const u8 gText_Release50[] = _("great majority."); 
const u8 gText_Release51[] = _(""); 
const u8 gText_Release52[] = _("{DYNAMIC 0x00} lost their "); 
const u8 gText_Release53[] = _("life."); 
const u8 gText_Release54[] = _(""); 
const u8 gText_Release55[] = _("{DYNAMIC 0x00} has met their "); 
const u8 gText_Release56[] = _("maker."); 
const u8 gText_Release57[] = _(""); 
const u8 gText_Release58[] = _("{DYNAMIC 0x00} was removed "); 
const u8 gText_Release59[] = _("from life support."); 
const u8 gText_Release60[] = _(""); 
const u8 gText_Release61[] = _("{DYNAMIC 0x00} crossed the "); 
const u8 gText_Release62[] = _("rainbow bridge to "); 
const u8 gText_Release63[] = _("Valhalla."); 
const u8 gText_Release64[] = _("{DYNAMIC 0x00} was "); 
const u8 gText_Release65[] = _("terminated."); 
const u8 gText_Release66[] = _(""); 
const u8 gText_Release67[] = _("{DYNAMIC 0x00} was erased. "); 
const u8 gText_Release68[] = _("Erased… from existence."); 
const u8 gText_Release69[] = _(""); 
const u8 gText_Release70[] = _("{DYNAMIC 0x00} was wasted."); 
const u8 gText_Release71[] = _(""); 
const u8 gText_Release72[] = _(""); 
const u8 gText_Release73[] = _("{DYNAMIC 0x00} was wiped out."); 
const u8 gText_Release74[] = _(""); 
const u8 gText_Release75[] = _(""); 
const u8 gText_Release76[] = _("{DYNAMIC 0x00} was destroyed."); 
const u8 gText_Release77[] = _(""); 
const u8 gText_Release78[] = _(""); 
const u8 gText_Release79[] = _("{DYNAMIC 0x00} was pumped "); 
const u8 gText_Release80[] = _("full of lead."); 
const u8 gText_Release81[] = _(""); 
const u8 gText_Release82[] = _("{DYNAMIC 0x00} is history."); 
const u8 gText_Release83[] = _(""); 
const u8 gText_Release84[] = _(""); 
const u8 gText_Release85[] = _("{DYNAMIC 0x00} died of a "); 
const u8 gText_Release86[] = _("broken heart."); 
const u8 gText_Release87[] = _(""); 
const u8 gText_Release88[] = _("{DYNAMIC 0x00} went on to a "); 
const u8 gText_Release89[] = _("better place."); 
const u8 gText_Release90[] = _(""); 
const u8 gText_Release91[] = _("{DYNAMIC 0x00} went to the "); 
const u8 gText_Release92[] = _("glue factory."); 
const u8 gText_Release93[] = _(""); 
const u8 gText_Release94[] = _("{DYNAMIC 0x00} is now "); 
const u8 gText_Release95[] = _("extinct."); 
const u8 gText_Release96[] = _(""); 
const u8 gText_Release97[] = _("{DYNAMIC 0x00} fell off the "); 
const u8 gText_Release98[] = _("toilet."); 
const u8 gText_Release99[] = _(""); 
const u8 gText_Release100[] = _("{DYNAMIC 0x00} was "); 
const u8 gText_Release101[] = _("exterminated."); 
const u8 gText_Release102[] = _(""); 
const u8 gText_Release103[] = _("{DYNAMIC 0x00} was abandoned "); 
const u8 gText_Release104[] = _("in a roadside ditch."); 
const u8 gText_Release105[] = _(""); 
const u8 gText_Release106[] = _("{DYNAMIC 0x00} was left in a "); 
const u8 gText_Release107[] = _("shallow grave."); 
const u8 gText_Release108[] = _(""); 
const u8 gText_Release109[] = _("{DYNAMIC 0x00} bought the "); 
const u8 gText_Release110[] = _("farm."); 
const u8 gText_Release111[] = _(""); 
const u8 gText_Release112[] = _("{DYNAMIC 0x00} bit the dust."); 
const u8 gText_Release113[] = _(""); 
const u8 gText_Release114[] = _(""); 
const u8 gText_Release115[] = _("{DYNAMIC 0x00} went beyond "); 
const u8 gText_Release116[] = _("the veil."); 
const u8 gText_Release117[] = _(""); 
const u8 gText_Release118[] = _("{DYNAMIC 0x00} is now at "); 
const u8 gText_Release119[] = _("peace."); 
const u8 gText_Release120[] = _(""); 
const u8 gText_Release121[] = _("{DYNAMIC 0x00} has gone away."); 
const u8 gText_Release122[] = _(" It's so hard to say "); 
const u8 gText_Release123[] = _("goodbye to yesterday."); 
const u8 gText_Release124[] = _("{DYNAMIC 0x00} went to hell. "); 
const u8 gText_Release125[] = _("It burns forever."); 
const u8 gText_Release126[] = _(""); 
const u8 gText_Release127[] = _("{DYNAMIC 0x00} took a bat to "); 
const u8 gText_Release128[] = _("the face."); 
const u8 gText_Release129[] = _(""); 
const u8 gText_Release130[] = _("{DYNAMIC 0x00} can finally "); 
const u8 gText_Release131[] = _("rest."); 
const u8 gText_Release132[] = _(""); 
const u8 gText_Release133[] = _("{DYNAMIC 0x00} was useless "); 
const u8 gText_Release134[] = _("anyway."); 
const u8 gText_Release135[] = _(""); 
const u8 gText_Release136[] = _("{DYNAMIC 0x00} has been "); 
const u8 gText_Release137[] = _("replaced."); 
const u8 gText_Release138[] = _(""); 
const u8 gText_Release139[] = _("{DYNAMIC 0x00} was snuffed "); 
const u8 gText_Release140[] = _("out."); 
const u8 gText_Release141[] = _(""); 
const u8 gText_Release142[] = _("{DYNAMIC 0x00} cried as it "); 
const u8 gText_Release143[] = _("slowly suffocated under "); 
const u8 gText_Release144[] = _("a pillow."); 
const u8 gText_Release145[] = _("{DYNAMIC 0x00} doesn't wanna "); 
const u8 gText_Release146[] = _("go, Mr. Stark."); 
const u8 gText_Release147[] = _(""); 
const u8 gText_Release148[] = _("{DYNAMIC 0x00} closed its "); 
const u8 gText_Release149[] = _("eyes for the last time."); 
const u8 gText_Release150[] = _(""); 
const u8 gText_Release151[] = _("{DYNAMIC 0x00} turned in for "); 
const u8 gText_Release152[] = _("the big sleep."); 
const u8 gText_Release153[] = _(""); 
const u8 gText_Release154[] = _("{DYNAMIC 0x00} is done being "); 
const u8 gText_Release155[] = _("alive."); 
const u8 gText_Release156[] = _(""); 
const u8 gText_Release157[] = _("{DYNAMIC 0x00} is shiny and "); 
const u8 gText_Release158[] = _("chrome. WITNESS THEM!"); 
const u8 gText_Release159[] = _(""); 
const u8 gText_Release160[] = _("{DYNAMIC 0x00} shall become "); 
const u8 gText_Release161[] = _("more powerful than you "); 
const u8 gText_Release162[] = _("can possibly imagine."); 
const u8 gText_Release163[] = _("{DYNAMIC 0x00} drank from "); 
const u8 gText_Release164[] = _("the wrong chalice."); 
